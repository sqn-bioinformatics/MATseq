...
for sample in samplelist:
    ...
    open("temp/unique_fastq/" + sample + "_Bruno_R1.fastq", "w").writelines(ddR1)
    del ddR1

    open("temp/unique_fastq/" + sample + "_Bruno_R2.fastq", "w").writelines(ddR2)
    del ddR2

    open("temp/unique_fastq/" + sample + "_Bruno_R3.fastq", "w").writelines(ddR3)
    del ddR3
